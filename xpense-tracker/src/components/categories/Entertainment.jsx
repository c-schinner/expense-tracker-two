...
const Entertainment = ({ onAddExpense }) => {
    ...
    return (
        <div className="flex-1 mix-blend-color-burn text-center p-10">
            <div className="h-auto border-4 border-black rounded-md p-4 m-4 font-bold max-w-4xl mx-auto justify-center">
                    <h2 className="text-3xl mb-4">Entertainment</h2>  
                <div className="flex flex-col sm:flex-row justify-center items-center sm:space-x-2 mb-4">
                    <input 
                    type="text"
